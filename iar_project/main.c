...
//    arm_max_f32(testOutput, fftSize, &maxValue, &testIndex);
    ...
    * Put results in file
    */
    fp = fopen("C:\\Users\\lazar\\Documents\\32bit\\filterFFT_float.bin", "wb");
    if(fp == NULL)
    {
      printf("Could not open file.\n");
      return 1;
    ...
    for(int i = 0; i < NFFT; i+=2)
    	fwrite(&filter[i], sizeof(float32_t), 1, fp);
    fclose(fp);
    printf("Writing filter FFT to the file finished...\r\n");
    
//    /* Initialize FFT instance */
//     arm_rfft_fast_init_f32(&FFT, NFFT);
//         
//    // SAMPLES FFT
//    // Find and subtract mean value
//    arm_mean_f32(samples, NSig, &meanSignal);
//    arm_offset_f32(samples, -meanSignal, samples, NSig);
//    
//    // Calculate FFT
//    arm_rfft_fast_f32(&FFT, samples, samples, 0);
//    arm_abs_f32(samples, samples, NFFT);
//    
//    // FILTER FFT
//    // Find and subtract mean value
//    arm_mean_f32(filter, 512, &meanSignal);
//    arm_offset_f32(filter, -meanSignal, filter, 512);
//    
//    // Calculate FFT
//    arm_rfft_fast_f32(&FFT, filter, filter, 0);
//    arm_abs_f32(filter, filter, NFFT);
    ...
    // Calculate IFFT
//    arm_rfft_fast_f32(&FFT, output, output, 1);
//    arm_abs_f32(output, output, NFFT);    
